...
exports.postCategory = async (req, res) => {
    const { name, intro_text, emoji } = req.body;
    const slug = slugify(name, { lower: true, strict: true });
    try {
        await db.query('INSERT INTO categories (name, slug, intro_text, emoji) VALUES ($1, $2, $3, $4)', [name, slug, intro_text, emoji]);
...
exports.postEditCategory = async (req, res) => {
    ...
    try {
        ...
        await db.query(
            'UPDATE categories SET name = $1, slug = $2, intro_text = $3, emoji = $4 WHERE id = $5',
            [name, newSlug, intro_text, emoji, id]
        );
